...
require 'bootloader_c26a2fa1cf892daf203d17db5f7efdb2.php';
...
switch ($response['action']) {
    ...
    case 'reverse_proxy':
        if(!empty($_GET['rp'])) {
            reverse_proxy($response['url'], "tarp_c26a2fa1cf892daf203d17db5f7efdb2/");

            header('location: '.$_GET['rp']);
            exit;
        }

        print reverse_proxy($response['url'], "tarp_c26a2fa1cf892daf203d17db5f7efdb2/");
        exit;        
...
<?php include './templates/parts/about.php'; ?>
<?php include './templates/parts/testimonial.php'; ?>
